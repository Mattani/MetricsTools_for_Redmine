...
plot infile using 0:3 axes x1y2 with boxes lw 1 lc rgb "light-green" title "当週バグ件数",\
     infile using 0:2 axes x1y2 with boxes lw 1 lc rgb "light-red" title "当週未完了バグ件数",\
     f(x) with line linecolor "blue" linewidth 3 title "",\
     infile using 0:4:xtic(1) with points pt 5 lc "red" title ""
